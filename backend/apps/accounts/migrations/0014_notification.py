# Generated by Django 5.1.7 on 2026-03-13 16:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0013_pulserating_pulse'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('rental_proposal', 'Rental Proposal'), ('chat_message', 'Chat Message')], max_length=50)),
